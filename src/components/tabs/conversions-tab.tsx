	...
	return (
		...
		>
			...
			<TransactionItem
				...
				borderColor={SEMI_GREEN_COLOR}
				bgColor={
					currentTab === CONVERSIONS_TAB.APPROVED ? SEMI_GREEN_COLOR : undefined
				}
				amountColor={
					currentTab === CONVERSIONS_TAB.APPROVED ? grey[50] : SEMI_GREEN_COLOR
				}
			...
			<TransactionItem
				...
				bgColor={
					currentTab === CONVERSIONS_TAB.PENDING ? SEMI_GREEN_COLOR : undefined
				}
				borderColor={SEMI_GREEN_COLOR}
				amountColor={
			...
			<TransactionItem
				...
				bgColor={
					currentTab === CONVERSIONS_TAB.DECLINED ? SEMI_GREEN_COLOR : undefined
				}
				borderColor={SEMI_GREEN_COLOR}
				amountColor={
					currentTab === CONVERSIONS_TAB.DECLINED ? grey[50] : SEMI_GREEN_COLOR
				}
